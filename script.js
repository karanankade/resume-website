...
const resumeData = {
    skills: [
        { name: "UI-UX/APIs/Responsive Design", level: "★★★★★" }, 
        { name: "routing/subnetting/Linux", level: "★★★★★" },
        { name: "Strong understanding of Static Routing configuration and troubleshooting", level: "★★★★★" },
        { name: "Hands-on experience with Dynamic Routing protocols (RIP, OSPF, EIGRP)", level: "★★★★★" },
        { name: "Ability to configure and optimize OSPF (areas, cost, bandwidth, ABR)", level: "★★★★☆" },
        { name: "Knowledge of RIP protocol configuration and route propagation", level: "★★★★☆" },
        { name: "Experience in EIGRP setup and route metric tuning", level: "★★★★☆" },
        { name: "Skilled in route redistribution between static and dynamic routing", level: "★★★★☆" },
        { name: "Understanding of routing tables, metrics, and path selection", level: "★★★★★" },
        { name: "Experience with bandwidth-based routing decisions and failover paths", level: "★★★★☆" },
        { name: "Hands-on practice using Cisco Packet Tracer for routing labs", level: "★★★★★" },
        { name: "Strong networking fundamentals including IP addressing, subnetting, and routing logic", level: "★★★★★" },
        { name: "Experienced in using AI tools for web development", level: "★★★★★"},
        { name: "MySQL", level: "★★★☆☆" },
        { name: "Python", level: "★★★☆☆" },
        { name: "PHP", level: "★★☆☆☆" },
        { name: "SQL", level: "★★☆☆☆" },
        ...
        { name: "React.js", level: "★★★☆☆" },
        { name: "Node.js", level: "★★★☆☆" },
        { name: "Skilled in AI-assisted web development./Using AI tools to speed up web development", level: "★★★★★" },
        { name: "AI-assisted website development experience.", level: "★★★★★" }
